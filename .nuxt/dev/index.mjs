...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, setHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/icon/ico/uhtairdrop/node_modules/h3/dist/index.mjs';
import * as nodemailer from 'file:///Users/icon/ico/uhtairdrop/node_modules/nodemailer/lib/nodemailer.js';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/icon/ico/uhtairdrop/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/icon/ico/uhtairdrop/node_modules/devalue/index.js';
import destr from 'file:///Users/icon/ico/uhtairdrop/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/icon/ico/uhtairdrop/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/icon/ico/uhtairdrop/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/icon/ico/uhtairdrop/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/icon/ico/uhtairdrop/node_modules/@unhead/ssr/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/icon/ico/uhtairdrop/node_modules/unstorage/dist/index.mjs';
...
import { consola } from 'file:///Users/icon/ico/uhtairdrop/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/icon/ico/uhtairdrop/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/icon/ico/uhtairdrop/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/icon/ico/uhtairdrop/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/icon/ico/uhtairdrop/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/icon/ico/uhtairdrop/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _vuXwTPbtdu = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/icon/ico/uhtairdrop";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _9egMEkRkBh = (nitroApp) => {
...
const _lazy_YWScSZ = () => Promise.resolve().then(function () { return sendWelcome_post$1; });
const _lazy_ew37dL = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/__nuxt_error', handler: _lazy_ew37dL, lazy: true, middleware: false, method: undefined },
    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="background-color: #ffffff; margin-top: 20px; border-radius: 12px; overflow: hidden; border: 1px solid #eeeeee;">
        ...
        <tr>
            <td bgcolor="#333333" style="padding: 30px; text-align: center;">
                <p style="color: #ffffff; font-size: 12px; margin: 0;">\xA9 2026 UHT Foundation. All rights reserved.</p>
...
const sendWelcome_post$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: sendWelcome_post
});
...
const getClientManifest = () => import('file:///Users/icon/ico/uhtairdrop/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/icon/ico/uhtairdrop/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
