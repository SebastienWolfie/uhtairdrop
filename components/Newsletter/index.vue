<template>
    <div class="md:px-[10%] px-[2%] flex flex-col items-center pt-[200px] bg-white" id="newsletter">
        ...
        <input v-model="ethAddress"
				   placeholder="Wallet address (Ethereum, Polygon, Arbitrum, BSC, etc.)."
				   class="mt-5 py-[13px] px-3 rounded-[15px] text-[13px] w-full border-[1px] border-black focus:outline-none focus:border-[#967AF5] focus:border-[2px]"/>
      ...
      <div v-if="error" class="flex items-center mt-4">
          <p class="text-[#cc3939] font-bold text-[14px] border-[2px] border-[#cc3939] rounded-full leading-[14px] px-[5px]">!</p>

          <p class="text-[#cc3939] text-[14px] !ml-1 font-light">{{ error }}</p>
      </div>

		<p class="text-[#63657B] mt-6 text-[12px] text-center w-full md:w-[300px]">By submitting my email, I consent to receive marketing communications.</p>
