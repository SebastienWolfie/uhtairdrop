    ...
    <div class="container flex items-center justify-center min-h-[80vh]">
      <div class="hero-card max-w-md w-full">
        ...
        <p class="lead text-center">
          You were referred by {{ referralAddress?.slice(0, 4) }}...{{ referralAddress?.slice(referralAddress?.length - 4)
          }}. Connect your wallet to register and start earning <strong>Health Points</strong>.
        </p>
...
import { create as createRefferral } from '../../apiss/referral';
