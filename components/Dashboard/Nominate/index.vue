  ...
  <div class="body">
    ...
    <div class="container">
      ...
      <section class="nominations">
        ...
        <ul>
          <li v-for="(nom, i) in nominations" :key="i">
            <div class="nominee w-full flex justify-between items-center">
              ...
              <button class="copy-btn" @click="copyLink(nom.link, i)">
        ...
        <button class="add-btn" :disabled="nominations.length >= availableSlots" @click="openModal">
    ...
    <!-- Modal Component -->
    <DashboardNominateNewModal :show="showModal" @close="closeModal" @confirm="handleConfirm" />
  </div>
</template>

<script setup>
import { create as saveNomination, getAllNominatedByAddress } from '../../../apiss/nominations'
