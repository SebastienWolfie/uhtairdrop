<template>
    <Modal>
        ...
        <div class="relative h-[500px]">
            ...
            <div
                class="w-full h-full absolute opacity-60 rounded-3xl top-0 left-0 lg:!inline-block"
            ></div>
            ...
            <div class="absolute top-0 left-0 right-0 bottom-0 ">
                ...
                <div class="py-[40px] px-[15px] md:px-[35px] flex flex-col justify-between h-full overflow-y-scroll" >
                    ...
                    <p class="text-[#967AF5] font-extrabold text-[35px] leading-[40px] self-center">Complete Your Profile</p>
