        ...
        <div class="dropdown-container" v-if="showDropdown">
            ...
            <div class="dropdown-content shadow-2xl h-screen flex-col w-full">
                ...
                <div class="flex-col text-black w-full mt-16 cursor-pointer">
                    ...
                    <p class="mt-5" v-if="auth.nominationCountSlot" @click="navigateTo('/dashboard/dailyclaim')">Daily
                        Claim</p>
                    ...
                    <p class="mt-5" v-if="auth.nominationCountSlot" @click="navigateTo('/dashboard/nominate')">
                        Nomintation</p>
