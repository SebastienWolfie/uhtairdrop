<template>
    <Modal @close-dialog="() => {
        ...
        <DashboardClaimModalLoadingModal v-if="showLoading" :wallet-address="walletAddress" :token-amount="tokenAmount"
            :gas-fee="gasFee" @close="() => showLoading = false" @successful="() => {
                showLoading = false
                loading = false
                showSuccessful = true
            }" />
