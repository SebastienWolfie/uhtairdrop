import{i as x,r as g,a as m,x as l}from"./pA-L5z5-.js";import{G as O,J as j,K as P,v as y,w as v,z as k,A as C,ad as c,x as T}from"./BqACKYKw.js";import{n as U,c as f}from"./DpLUDbId.js";import{o as B}from"./DMVJ8XfO.js";import{e as E,n as L}from"./B3FXzDs5.js";import"./DxvyqeoR.js";import{R as W}from"./Dmg8YACJ.js";const u=O({isLegalCheckboxChecked:!1}),b={state:u,subscribe(n){return j(u,()=>n(u))},subscribeKey(n,e){return P(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},F=y`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
...
`;var $=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var s=n.length-1;s>=0;s--)(a=n[s])&&(t=(i<3?a(t):i>3?a(e,r,t):a(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let h=class extends k{constructor(){super(...arguments),this.inputElementRef=E(),this.checked=void 0}render(){return C`
    ...
    `}dispatchChangeEvent(){var e;this.dispatchEvent(new CustomEvent("checkboxChange",{detail:(e=this.inputElementRef.value)==null?void 0:e.checked,bubbles:!0,composed:!0}))}};h.styles=[v,F];$([U({type:Boolean})],h.prototype,"checked",void 0);h=$([f("wui-checkbox")],h);const D=x`
  :host {
    display: flex;
    align-items: center;
    justify-content: center;
...
`;var z=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var s=n.length-1;s>=0;s--)(a=n[s])&&(t=(i<3?a(t):i>3?a(e,r,t):a(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let w=class extends k{render(){return C`
    ...
    `}};w.styles=[v,T,K];w=z([f("wui-ux-by-reown")],w);const I=x`
  :host > wui-flex {
...
`;var R=function(n,e,r,o){var i=arguments.length,t=i<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,r):o,a;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")t=Reflect.decorate(n,e,r,o);else for(var s=n.length-1;s>=0;s--)(a=n[s])&&(t=(i<3?a(t):i>3?a(e,r,t):a(e,r))||t);return i>3&&t&&Object.defineProperty(e,r,t),t};let d=class extends m{constructor(){super(),this.unsubscribe=[],this.remoteFeatures=c.state.remoteFeatures,this.unsubscribe.push(c.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){var t;const{termsConditionsUrl:e,privacyPolicyUrl:r}=c.state,o=(t=c.state.features)==null?void 0:t.legalCheckbox;return!e&&!r||o?l`
    ...
    >`:null}privacyTemplate(){const{privacyPolicyUrl:e}=c.state;return e?l`<a href=${e} target="_blank" rel="noopener noreferrer"
      >Privacy Policy</a
    >`:null}reownBrandingTemplate(e=!1){var r;return(r=this.remoteFeatures)!=null&&r.reownBranding?e?l`<wui-ux-by-reown class="branding-only"></wui-ux-by-reown>`:l`<wui-ux-by-reown></wui-ux-by-reown>`:null}};d.styles=[I];R([g()],d.prototype,"remoteFeatures",void 0);d=R([f("w3m-legal-footer")],d);export{b as O};
