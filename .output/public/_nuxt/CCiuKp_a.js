import{i as g,r as u,a as m,x as w}from"./pA-L5z5-.js";import{G as f,H as v,J as b,K as x}from"./BqACKYKw.js";import{c as h}from"./DpLUDbId.js";import"./DxvyqeoR.js";const e=f({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),y={state:e,subscribe(o){return b(e,()=>o(e))},subscribeKey(o,t){return x(e,o,t)},showTooltip({message:o,triggerRect:t,variant:i}){e.open=!0,e.message=o,e.triggerRect=t,e.variant=i},hide(){e.open=!1,e.message="",e.triggerRect={width:0,height:0,top:0,left:0}}},s=v(y),R=g`
  :host {
    pointer-events: none;
  }
